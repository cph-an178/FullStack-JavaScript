...
function makeTable(persons) {
    var htmlTable = "<table><tr><th>First Name</th><th>Last Name</th><th>Facorite Sport</th></tr>";

    Map.persons(function (p) {
        htmlTable + "<tr><td>" + p.firstName + "</td><td>" + p.lastName + "</td><td>" + p.favoriteSport + "</td></tr>";
    });
